...
fun NohyScreen(navController: NavController) {
    val cviky = remember {
        listOf(
            Cviky("Kvadricepsy", R.drawable.predkopavanie, "Popis cviku ", R.drawable.legpress, "Popis cviku "),
            Cviky("Hamstringy", R.drawable.zakopavanie, "Popis cviku ", R.drawable.mrtvy, "Popis cviku "),
            Cviky("Lítka", R.drawable.litka1, "Popis cviku ", R.drawable.litka2, "Popis cviku "),
        )
    }
